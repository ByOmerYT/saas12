...
client.on("guildDelete", guild => {
  ...
  client.channels.get("802612267916197918  ").send(rrrsembed);
});
//Cross
...
client.on('message', msg => {
  if (msg.content === 'BlacX') {
    msg.channel.send(`> <@!${msg.author.id}> Buyur Canım Benim **-yardım** Yazarak marifetlerimi görebilirsin!`)
  }
})
...
if(!msg.guild) return
    ...
    .setColor("RANDOM")
    .setDescription(`<:dev:803924002547826688> **• Prefixim c!**  \n **\<:dev:803924002547826688> • c!yardım yazarak komutlarımı kategorileriyle görebilirsin.**`)
